    ...
    <body id="body">
        ...
        <script type="text/javascript">
            ...
            function SubmitDownAjax(){
				...
				{
					alert("Запросы для поиска отсутствуют");
					return;
				}
				bool=0;
                id = setInterval("doAnimation()", 400);
                document.getElementById("progressBar").innerHTML = 'Поиск';
                document.title = 'Grabber Email: идет поиск...';
				SubmitDown();
                ...
                $.ajaxSetup({
                    ...
                    "success":function(sResponseText){
                        ...
                        if(sResponseText==0){
                            ...
                            document.title = 'Grabber Email: поиск завершен';
        ...
        <div id="main">
            <table width="100%" cellspacing="10" border="0">
                ...
                <tr><td width="30%">
                        <h4 id="h4">Введите запросы для поиска, каждый с новой строки:</h4>
